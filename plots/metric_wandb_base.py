...
# plots_dir 설정
# plots_dir = Path("large-diverse-1/norm/0.005-2")
plots_dir = Path("large-diverse-3/base/0.003-base")
...
api = wandb.Api()
run = api.run("sjrhee/IQL-antmaze-large-diverse-v2-3-0.003-norm-grad-True/f019f9ed39144c8a942c0138b82658bc")
